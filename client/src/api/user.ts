...
export const checkDuplicateNickname = (nickname: string) => {
  return axios.get(
    `https://chae-recipe.koreacentral.cloudapp.azure.com/api/user/check?nickname=${nickname}`
  );
};
...
export const registerUserInfo = (userRegInfo: {
  ...
  return axios.post(
    `https://chae-recipe.koreacentral.cloudapp.azure.com/api/user/register`,
    userRegInfo
  );
};
...
export const logUserIn = (userInfo: { email: string; password: string }) => {
  return axios.post(
    `https://chae-recipe.koreacentral.cloudapp.azure.com/api/user/login`,
    userInfo
  );
};

const KAKAO_REDIRECT_URI =
  'http://chae-recipe.koreacentral.cloudapp.azure.com/user/kakao/callback';
...
export const sendKakaoAuthCode = (authCode: string | null) => {
  return axios.get(
    `https://chae-recipe.koreacentral.cloudapp.azure.com/api/user/callback/kakao?code=${authCode}`,
    {
...
const GOOGLE_REDIRECT_URI =
  'https://chae-recipe.koreacentral.cloudapp.azure.com/user/google/callback';
...
export const sendGoogleAuthCode = (authCode: string | null) => {
  return axios.get(
    `https://chae-recipe.koreacentral.cloudapp.azure.com/api/user/callback/google?code=${authCode}`
  );
};
